...
const file_proto_streaming_proto_rawDesc = "" +
	"\n" +
	"\x15proto/streaming.proto\x12\tstreaming\"\a\n" +
	"\x05Empty\".\n" +
	"\x04Item\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value2<\n" +
	"\bStreamer\x120\n" +
	"\tListItems\x12\x10.streaming.Empty\x1a\x0f.streaming.Item0\x01B0Z.distributed-systems/grpc-practices/proto;protob\x06proto3"
...
var file_proto_streaming_proto_goTypes = []any{
	(*Empty)(nil), // 0: streaming.Empty
	(*Item)(nil),  // 1: streaming.Item
}
var file_proto_streaming_proto_depIdxs = []int32{
	0, // 0: streaming.Streamer.ListItems:input_type -> streaming.Empty
	1, // 1: streaming.Streamer.ListItems:output_type -> streaming.Item
